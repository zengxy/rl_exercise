...
RL_natural = DQNPrioritizedReplay(
    n_actions=env.action_space.n, n_features=4, memory_size=MEMORY_SIZE,
...
tf.summary.FileWriter("/tmp/DQN11/", sess.graph)
...
def train(RL):
    ...
    for i_episode in range(200000):
        ...
        while True:
            ...
            if done:
                print('episode: {:d}, rewards: {:.3f}'.format(i_episode, rewards), i_episode)
